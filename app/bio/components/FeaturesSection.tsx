...
export default function FeaturesSection() {
  return (
    <section className="pb-16 md:pb-24" style={{ backgroundColor: '#0A0A0A' }}>
      <div className="mx-auto max-w-5xl px-6">
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2" style={{ backgroundColor: '#0D0D0D', borderColor: '#1A1A1A' }}>
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  <svg
                    className="text-cyan-700 absolute inset-0 size-full"
                    viewBox="0 0 254 104"
                    fill="none"
                  ...
                  <span className="mx-auto block w-fit text-5xl text-cyan-500 font-semibold">
                    100%
                  </span>
                </div>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2" style={{ backgroundColor: '#0D0D0D', borderColor: '#1A1A1A' }}>
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                  <Settings className="m-auto h-16 w-16 text-blue-700" strokeWidth={1} />
                </div>
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h2 className="text-lg font-medium text-white">
                    <span className="text-blue-600">Mais tempo</span> para o que importa
                  </h2>
                  <p className="text-gray-400">
                    Automatize processos repetitivos e foque no seu negócio.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2" style={{ backgroundColor: '#0D0D0D',  borderColor: '#1A1A1A' }}>
              <CardContent className="pt-6">
                <div className="relative mx-auto h-32 w-full mb-6">
                  <IntegrationsCard />
                </div>
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h2 className="text-lg font-medium text-white">
                    <span className="text-purple-500">Integrações</span> inteligentes
                  </h2>
                  <p className="text-gray-400">
                    Todas as suas ferramentas e dados em um só lugar.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="relative col-span-full overflow-hidden lg:col-span-3" style={{ backgroundColor: '#0D0D0D',  borderColor: '#1A1A1A' }}>
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                    <Zap className="m-auto size-5 text-green-400" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-white">
                      <span className="text-green-400">Resultados</span> mais rápidos
                    </h2>
                    <p className="text-gray-400">
                    Otimize processos e entregue resultados em menos tempo com mais qualidade.
                    </p>
                  </div>
                </div>
                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-zinc-700 p-6 py-6 sm:ml-6">
            ...
            <Card className="relative col-span-full overflow-hidden lg:col-span-3" style={{ backgroundColor: '#0D0D0D',  borderColor: '#1A1A1A' }}>
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                    <Sparkles className="m-auto size-6 text-yellow-400" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-white">
                      <span className="text-yellow-400">Entregas</span> que encantam
                    </h2>
                    <p className="text-gray-400">
                      Impressione seus clientes com organização, profissionalismo e qualidade.
                    </p>
                  </div>
                </div>
                <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-zinc-700 sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border border-zinc-700 bg-zinc-800 text-zinc-800 px-2 py-1 text-xs shadow-sm">
                        ------
                      </span>
